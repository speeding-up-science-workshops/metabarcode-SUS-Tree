...
#ps_small <- subset_taxa(ps, Order=='o__Rickettsiales')
...
pt <- interactive_plot_tree(ps_small, ladderize="left", color="Depth", size='abundance', nodelabf=nodeplotblank, base.spacing=0.1, tooltip = 'Lowest_taxa')
